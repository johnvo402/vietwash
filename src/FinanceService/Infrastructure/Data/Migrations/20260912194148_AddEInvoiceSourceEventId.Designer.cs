...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20260912194148_AddEInvoiceSourceEventId")]
    partial class AddEInvoiceSourceEventId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Aggregates.EInvoices.EInvoice", b =>
                {
                    ...
                    b.HasIndex("SourceEventId")
                        .IsUnique()
                        .HasDatabaseName("ix_e_invoice_source_event_id")
            ...
            modelBuilder.Entity("Domain.Aggregates.Funds.Fund", b =>
                {
                    ...
                    b.HasIndex("SourceEventId")
                        .IsUnique()
                        .HasDatabaseName("ix_fund_source_event_id")
                        .HasFilter("source_event_id IS NOT NULL");
