...
public class ListFeedbackByServiceMapping
{
	public static Expression<Func<Feedback, ListFeedbackByServiceResponse>> Selector()
	{
		return feedback => new ListFeedbackByServiceResponse
		{
			Id = feedback.Id,
