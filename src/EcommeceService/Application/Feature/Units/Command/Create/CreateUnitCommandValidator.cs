...
namespace Application.Feature.Units.Command.Create
{
    public partial class CreateUnitCommandValidator : AbstractValidator<CreateUnitCommand>
    {
        ...
        public CreateUnitCommandValidator(IUnitOfWork unitOfWork, IActionAccessorService accessorService)
        {
        ...
        private async Task<bool> IsNameUniqueAsync(string name, CancellationToken cancellationToken = default)
        {
