...
{
    public class ProductImportItemValidator : AbstractValidator<ProductImportItem>
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly IActionAccessorService accessorService;

        public ProductImportItemValidator(IUnitOfWork unitOfWork, IActionAccessorService accessorService)
        {
