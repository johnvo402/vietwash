...
namespace Application.Common.HandleEventDomains.Orders
{
    public class UpdateStatusOrderEventHandler : INotificationHandler<UpdateStatusOrderEvent>
    {
        ...
        public UpdateStatusOrderEventHandler(IUnitOfWork unitOfWork, INotificationGrpc notification)
        {
        ...
        )
        {
            ...
            try
            {
                var notifySend = new SendNotificationRequest { TemplateId = "laundry_processed" };
