...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20250312172436_20250313002415_Project_Migration")]
    partial class _20250313002415_Project_Migration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Aggregates.Funds.Fund", b =>
                {
                    ...
                    b.HasIndex("PaymentMethodId")
                        .HasDatabaseName("ix_fund_payment_method_id");
            ...
            modelBuilder.Entity("Domain.Aggregates.Funds.PaymentMethod", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Aggregates.Orders.OrderPayment", b =>
                {
                    ...
                    b.HasIndex("PaymentMethodId")
                        .HasDatabaseName("ix_order_payment_payment_method_id");
            ...
            modelBuilder.Entity("Domain.Aggregates.Funds.Fund", b =>
                {
                    ...
                    b.HasOne("Domain.Aggregates.Funds.PaymentMethod", "PaymentMethod")
                        .WithMany("Funds")
                        .HasForeignKey("PaymentMethodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_fund_payment_method_payment_method_id");
            ...
            modelBuilder.Entity("Domain.Aggregates.Orders.OrderPayment", b =>
                {
                    ...
                    b.HasOne("Domain.Aggregates.Funds.PaymentMethod", "PaymentMethod")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_payment_payment_method_payment_method_id");
