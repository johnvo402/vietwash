...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20260913172744_DurablePayOsCancellationSaga")]
    partial class DurablePayOsCancellationSaga
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Aggregates.Inventories.InventoryDocument", b =>
                {
                    ...
                    b.HasIndex("SourceOrderId")
                        .IsUnique()
                        .HasDatabaseName("ix_inventory_document_source_order_id")
            ...
            modelBuilder.Entity("Domain.Aggregates.Orders.PayOsCancellationRequest", b =>
                {
                    b.Property<long>("OrderId")
                        .HasColumnType("bigint")
                        .HasColumnName("order_id");
                    ...
                    b.HasKey("OrderId")
                        .HasName("pk_payos_cancellation_request");

                    b.HasIndex("State", "NextAttemptAt", "LockedUntil")
                        .HasDatabaseName("ix_payos_cancellation_request_state_next_attempt_at_locked_unt");

                    b.ToTable("payos_cancellation_request", (string)null);
                });
            ...
            modelBuilder.Entity("Infrastructure.IntegrationEvents.IntegrationOutbox", b =>
                {
                    ...
                    b.HasIndex("NextAttemptAt", "LockedUntil")
                        .HasDatabaseName("ix_integration_outbox_next_attempt_at_locked_until")
            ...
            modelBuilder.Entity("Domain.Aggregates.Services.ServiceResource", b =>
                {
                    b.HasOne("Domain.Aggregates.Products.BranchProduct", "BranchProduct")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_service_resource_branch_product_product_id");
