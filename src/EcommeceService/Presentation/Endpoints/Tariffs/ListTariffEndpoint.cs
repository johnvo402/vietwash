...
namespace Presentation.Endpoints.Tariffs
{
    public class ListTariffEndpoint(ISender sender)
        : EndpointBaseAsync.WithRequest<ListTariffQuery>.WithActionResult<ApiResponse<PaginationResponse<ListTariffResponse>>>
    {
        ...
        public async override Task<ActionResult<ApiResponse<PaginationResponse<ListTariffResponse>>>> HandleAsync(ListTariffQuery request,
