...
namespace Presentation.Endpoints.Orders
{
	...
	: EndpointBaseAsync.WithRequest<ListOrderQuery>.WithActionResult<ApiResponse<PaginationResponse<ListOrderResponse>>>
	{
		...
		public override async Task<ActionResult<ApiResponse<PaginationResponse<ListOrderResponse>>>> HandleAsync(
			ListOrderQuery request, 
