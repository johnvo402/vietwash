    ...
    where T : class
{
    ...
    private readonly Dictionary<MessageType, MessageDictionary> Messages = new()
    {
        {
        ...
        },
        {
            ...
            new(
                ...
                new Dictionary<string, string>
                {
                    { LanguageType.En.ToString(), MessageType.Existence.ToString().ToKebabCase() },
        ...
        },
        {
            ...
            new(
                ...
                new Dictionary<string, string>
                {
                    { LanguageType.En.ToString(), MessageType.Correct.ToString().ToKebabCase() },
